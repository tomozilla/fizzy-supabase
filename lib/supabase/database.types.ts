  ...
  public: {
    Tables: {
      account_join_codes: {
        ...
        Relationships: [
          {
            foreignKeyName: "account_join_codes_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "account_join_codes_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
      ...
      assignments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "assignments_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
      ...
      columns: {
        ...
        Relationships: [
          {
            foreignKeyName: "columns_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      filters: {
        ...
        Relationships: [
          {
            foreignKeyName: "filters_account_id_fkey"
            columns: ["account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
      ...
      pins: {
        ...
        Relationships: [
          {
            foreignKeyName: "pins_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
            referencedRelation: "cards"
            referencedColumns: ["id"]
      ...
      taggings: {
        ...
        Relationships: [
          {
            foreignKeyName: "taggings_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
            referencedRelation: "cards"
            referencedColumns: ["id"]
      ...
      watches: {
        ...
        Relationships: [
          {
            foreignKeyName: "watches_card_id_fkey"
            columns: ["card_id"]
            isOneToOne: false
            referencedRelation: "cards"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      redeem_join_code: { Args: { join_code: string }; Returns: string }
    }
    Enums: {
